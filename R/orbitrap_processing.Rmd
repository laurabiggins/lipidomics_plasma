...
This doesn't work as residual df = 0
...
Changes at the class level are mostly not significant, so we'll do another anova 
but this time at the individual lipid level.  
...
chain_data %>%
  ggplot(aes(x = chain_length, y = log2_value, col = condition)) +
  geom_point(position= position_dodge(width = 0.5)) +
  #geom_point(position= position_dodge(width = 0.5), aes(shape = double_bonds)) +
